...
namespace DeepSight
{
    public partial class CFormCommunication : Form, CFormInterface
    {
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		// private
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        // 현재 폼
        private CDefine.FormViewCommunication m_eCurrentForm = CDefine.FormViewCommunication.FORM_VIEW_COMMUNICATION_FINAL;
        // 폼 (화면이 전환되는 폼)
        ...
        //설명 : 
        //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        private void CFormCommunication_Load( object sender, EventArgs e )
        {
            // 초기화
            Initialize();
        }
        ...
        //설명 : 
        //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        private void CFormCommunication_FormClosed( object sender, FormClosedEventArgs e )
        {
            // 해제
            DeInitialize();
        }
        ...
        public bool InitializeForm()
        {
            ...
            do {
                ...
                int iMenuCount = ( int )CDefine.FormViewCommunication.FORM_VIEW_COMMUNICATION_FINAL;
                // 버튼 여백 & 넓이 설정
                int iWhiteSpace = 2;
                ...
                for( int iLoopMenu = 0; iLoopMenu < m_btnMenu.Length; iLoopMenu++ ) {
                    m_btnMenu[ iLoopMenu ].Name = string.Format( "BtnIOMenu[{0}]", iLoopMenu );
                }
                // 폼 생성
                m_stForm = new structureForm[ iMenuCount ];
                // 화면 전환
                SetChangeForm( CDefine.FormViewCommunication.FORM_VIEW_COMMUNICATION_PLC );
        ...
        public bool SetChangeLanguage()
        {
            ...
            do {
				...
				//SetControlChangeLanguage( m_btnMenu[ ( int )CDefine.FormViewCommunication.FORM_VIEW_COMMUNICATION_IO ] );
				SetControlChangeLanguage( m_btnMenu[ ( int )CDefine.FormViewCommunication.FORM_VIEW_COMMUNICATION_PLC ] );
        ...
        public void ButtonMenu_Click( object sender, EventArgs e )
        {
            ...
            try {
                ...
                if( true == objRegex.IsMatch( objButton.Name ) ) {
					...
					CDefine.FormViewCommunication eFormView = ( CDefine.FormViewCommunication )Convert.ToInt32( strText );
        ...
        {
			var pFormCommon = CFormCommon.GetFormCommon;
			for( int iLoopMenu = 0; iLoopMenu < ( int )CDefine.FormViewCommunication.FORM_VIEW_COMMUNICATION_FINAL; iLoopMenu++ ) {
