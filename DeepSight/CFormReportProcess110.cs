...
namespace DeepSight
{
    public partial class CFormReportProcess110 : Form, CFormInterface
    {
        //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        // private
        //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        public enum enumDisplayIndex { PMS, VIDI_1, VIDI_2, VIDI_3, MEASURE_1, MEASURE_2, MEASURE_3, DISPLAY_FINAL };
...
//                 }
		...
		private bool InitializeGridView( DataGridView objGridView )
		{
			...
			do {
                ...
                objGridView.Columns[ ( int )CDatabaseDefine.enumHistoryAlign.VIDI_SCORE_4 ].Width = 0;
                objGridView.Columns[ ( int )CDatabaseDefine.enumHistoryAlign.VIDI_RESULT_4 ].Width = 0;
                objGridView.Columns[ ( int )CDatabaseDefine.enumHistoryAlign.VIDI_SCORE_5 ].Width = 0;
                objGridView.Columns[ ( int )CDatabaseDefine.enumHistoryAlign.VIDI_RESULT_5 ].Width = 0;
                objGridView.Columns[ ( int )CDatabaseDefine.enumHistoryAlign.VIDI_SCORE_6 ].Width = 0;
                objGridView.Columns[ ( int )CDatabaseDefine.enumHistoryAlign.VIDI_RESULT_6 ].Width = 0;
                ...
                objGridView.Columns[ ( int )CDatabaseDefine.enumHistoryAlign.HEIGHT_RESULT_1 ].Width = 0;
                objGridView.Columns[ ( int )CDatabaseDefine.enumHistoryAlign.HEIGHT_RESULT_2 ].Width = 0;
                objGridView.Columns[ ( int )CDatabaseDefine.enumHistoryAlign.HEIGHT_RESULT_3 ].Width = 0;
                objGridView.Columns[ ( int )CDatabaseDefine.enumHistoryAlign.HEIGHT_RESULT_4 ].Width = 0;
                objGridView.Columns[ ( int )CDatabaseDefine.enumHistoryAlign.HEIGHT_RESULT_5 ].Width = 0;
                objGridView.Columns[ ( int )CDatabaseDefine.enumHistoryAlign.HEIGHT_RESULT_6 ].Width = 0;
...
//             if( CDefine.enumMachineType.MACHINE_2_POL == eMachineType ) {
//                 // STAGE_POL
//                 if( CDefine.enumAlignStage.STAGE_MAIN == m_eStage ) {
//                     pFormCommon.SetButtonBackColor( this.BtnStageA, pFormCommon.COLOR_ACTIVATE );
//                     pFormCommon.SetButtonBackColor( this.BtnStageB, pFormCommon.COLOR_UNACTIVATE );
//                     pFormCommon.SetButtonBackColor( this.BtnStageALL, pFormCommon.COLOR_UNACTIVATE );
//                 } else if( CDefine.enumAlignStage.STAGE_POL_B == m_eStage ) {
//                     pFormCommon.SetButtonBackColor( this.BtnStageA, pFormCommon.COLOR_UNACTIVATE );
//                     pFormCommon.SetButtonBackColor( this.BtnStageB, pFormCommon.COLOR_ACTIVATE );
//                     pFormCommon.SetButtonBackColor( this.BtnStageALL, pFormCommon.COLOR_UNACTIVATE );
//                 } else if( CDefine.enumAlignStage.STAGE_FINAL == m_eStage ) {
//                     pFormCommon.SetButtonBackColor( this.BtnStageA, pFormCommon.COLOR_UNACTIVATE );
//                     pFormCommon.SetButtonBackColor( this.BtnStageB, pFormCommon.COLOR_UNACTIVATE );
//                     pFormCommon.SetButtonBackColor( this.BtnStageALL, pFormCommon.COLOR_ACTIVATE );
//                 }
//             } else if( CDefine.enumMachineType.MACHINE_SAD == eMachineType ) {
//                 // STAGE_POL
//                 if( CDefine.enumAlignStage.STAGE_MAIN == m_eStage ) {
...
//                     pFormCommon.SetButtonBackColor( this.BtnStageB, pFormCommon.COLOR_UNACTIVATE );
//                     pFormCommon.SetButtonBackColor( this.BtnStageALL, pFormCommon.COLOR_UNACTIVATE );
//                 } else if( CDefine.enumAlignStage.STAGE_PANEL_A == m_eStage ) {
//                     pFormCommon.SetButtonBackColor( this.BtnStageA, pFormCommon.COLOR_UNACTIVATE );
//                     pFormCommon.SetButtonBackColor( this.BtnStageB, pFormCommon.COLOR_ACTIVATE );
//                     pFormCommon.SetButtonBackColor( this.BtnStageALL, pFormCommon.COLOR_UNACTIVATE );
//                 } else if( CDefine.enumAlignStage.STAGE_FINAL == m_eStage ) {
...
//             }
        ...
        private void UpdateDisplay( int iRowIndex )
        {
            try {
                ...
                ( m_objFormDisplay[ ( int )enumDisplayIndex.PMS ] as CFormDisplay ).UpdateDisplayHistoryPMS( objReportImage );
                ...
                for( int iLoopCount = 0; iLoopCount < 3; iLoopCount++ ) {
                    ...
                    objReportImage.dStartX = double.Parse( m_objDataRow[ iRowIndex ].ItemArray[ ( int )CDatabaseDefine.enumHistoryAlign.MEASURE_START_X_1 + ( iLoopCount * 4 ) ].ToString() );
                    objReportImage.dStartY = double.Parse( m_objDataRow[ iRowIndex ].ItemArray[ ( int )CDatabaseDefine.enumHistoryAlign.MEASURE_START_Y_1 + ( iLoopCount * 4 ) ].ToString() );
                    objReportImage.dEndX = double.Parse( m_objDataRow[ iRowIndex ].ItemArray[ ( int )CDatabaseDefine.enumHistoryAlign.MEASURE_END_X_1 + ( iLoopCount * 4 ) ].ToString() );
                    objReportImage.dEndY = double.Parse( m_objDataRow[ iRowIndex ].ItemArray[ ( int )CDatabaseDefine.enumHistoryAlign.MEASURE_END_Y_1 + ( iLoopCount * 4 ) ].ToString() );

                    ( m_objFormDisplay[ ( int )enumDisplayIndex.MEASURE_1 + iLoopCount ] as CFormDisplay ).UpdateDisplayHistoryMeasure( objReportImage );
                }
            } catch( Exception ex ) {
        ...
        {
            CFormReportProcess110 pThis = ( CFormReportProcess110 )state;
            // 스레드 주기
