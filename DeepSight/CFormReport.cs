...
namespace DeepSight
{
    public partial class CFormReport : Form, CFormInterface
    {
        //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        // private
        //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        // 현재 폼
        private CDefine.FormViewReport m_eCurrentForm = CDefine.FormViewReport.FORM_VIEW_REPORT_FINAL;
        // 폼 (화면이 전환되는 폼)
        ...
        //설명 : 
        //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		private void CFormReport_FormClosed( object sender, FormClosedEventArgs e )
        {
            // 해제
            DeInitialize();
        }
        ...
        public bool InitializeForm()
        {
            ...
            do {
                ...
                int iMenuCount = ( int )CDefine.FormViewReport.FORM_VIEW_REPORT_FINAL;
                // 버튼 여백 & 넓이 설정
                int iWhiteSpace = 2;
                ...
                for( int iLoopMenu = 0; iLoopMenu < m_btnMenu.Length; iLoopMenu++ ) {
                    m_btnMenu[ iLoopMenu ].Name = string.Format( "BtnReportMenu[{0}]", iLoopMenu );
                }
                // 폼 생성
                m_stForm = new structureForm[ iMenuCount ];
                // 화면 전환
                SetChangeForm( CDefine.FormViewReport.FORM_VIEW_REPORT_ALIGN );
...
//                             break;
        ...
        public bool SetChangeLanguage()
        {
            ...
            do {
				...
				SetControlChangeLanguage( m_btnMenu[ ( int )CDefine.FormViewReport.FORM_VIEW_REPORT_ALIGN ] );
				//SetControlChangeLanguage( m_btnMenu[ ( int )CDefine.FormViewReport.FORM_VIEW_REPORT_INSPECTION ] );
        ...
        public void ButtonMenu_Click( object sender, EventArgs e )
        {
            ...
            try {
                ...
                if( true == objRegex.IsMatch( objButton.Name ) ) {
					...
					CDefine.FormViewReport eFormView = ( CDefine.FormViewReport )Convert.ToInt32( strText );
        ...
        {
			var pFormCommon = CFormCommon.GetFormCommon;
			for( int iLoopMenu = 0; iLoopMenu < ( int )CDefine.FormViewReport.FORM_VIEW_REPORT_FINAL; iLoopMenu++ ) {
