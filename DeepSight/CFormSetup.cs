...
namespace DeepSight
{
    public partial class CFormSetup : Form, CFormInterface
    {
        //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        // private
        //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        public bool InitializeForm()
        {
            ...
            do {
                ...
                // 화면 전환
                SetChangeForm( CDefine.FormViewSetup.FORM_VIEW_SETUP_VISION_ALIGN );
        ...
        public bool SetChangeLanguage()
        {
            ...
            do {
                ...
                var pDocument = CDocument.GetDocument;
                SetControlChangeLanguage( m_btnMenu[ ( int )CDefine.FormViewSetup.FORM_VIEW_SETUP_VISION_ALIGN ] );
                if( CDefine.enumCameraType.CAMERA_AREA == pDocument.m_objConfig.GetSystemParameter().eCameraType || CDefine.enumMachineType.PROCESS_150 != pDocument.m_objConfig.GetSystemParameter().eMachineType )
                    SetControlChangeLanguage( m_btnMenu[ ( int )CDefine.FormViewSetup.FORM_VIEW_SETUP_CAMERA ] );
        ...
        private void timer_Tick(object sender, EventArgs e)
        {
            ...
            if( CDefine.enumCameraType.CAMERA_AREA == pDocument.m_objConfig.GetSystemParameter().eCameraType )
                iCount = ( int )CDefine.FormViewSetup.FORM_VIEW_SETUP_FINAL;
            else
                iCount = ( int )CDefine.FormViewSetup.FORM_VIEW_SETUP_FINAL - 1;

            for (int iLoopMenu = 0; iLoopMenu < iCount/*( int )CDefine.FormViewSetup.FORM_VIEW_SETUP_FINAL*/ ; iLoopMenu++) {
