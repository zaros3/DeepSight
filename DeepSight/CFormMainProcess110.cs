...
namespace DeepSight {
    public partial class CFormMainProcess110 : Form, CFormInterface {
        //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        // enumeration
        //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        public enum enumDisplayIndex { PMS, ORIGIN_1, ORIGIN_2, ORIGIN_3, ORIGIN_4, VIDI_1, VIDI_2, VIDI_3, MEASURE_1, MEASURE_2, MEASURE_3, DISPLAY_FINAL };
        //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        // public
        //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        // 로그 업데이트 델리게이트
        ...
        public DelegateUpdateDisplay m_delegateUpdateDisplayOriginal;
        public DelegateUpdateDisplay m_delegateUpdateDisplayPMS;
            ...
            do {
                ...
                // 디스플레이 화면 생성
                {
                    ...
                    for( int iLoopCount = 0; iLoopCount < m_objFormDisplay.Length; iLoopCount++ ) {
                        ...
                        if( ( int )enumDisplayIndex.VIDI_3 == iLoopCount || ( int )enumDisplayIndex.MEASURE_3 == iLoopCount )
                            m_objFormDisplay[ iLoopCount ].Hide();
        ...
        public void UpdateDisplayResultMeasure( enumDisplayIndex eDisplayIndex, CInspectionResult.CResult objResult )
        {
            ...
            do {
                ...
                obj.BeginInvoke( obj.m_objDelegateUpdateDisplayMeasure, objResult );

            } while( false );
        }

        public void UpdateDisplayOriginal( enumDisplayIndex eDisplayIndex, CInspectionResult.CResult objResult )
        {
            CFormDisplay obj = m_objFormDisplay[ ( int )eDisplayIndex ] as CFormDisplay;
            ...
            do {
                ...
                obj.BeginInvoke( obj.m_objDelegateUpdateDisplayOriginalImage, objResult );
        ...
        private void BtnTitleCameraAction_Click( object sender, EventArgs e )
        {
            ...
            do {
                if( CDefine.enumRunMode.RUN_MODE_START == pDocument.GetRunMode() ) break;
                if( false == pDocument.m_objConfig.GetSystemParameter().bVidiTeachMode ) break;
                ...
                try
                {
                    ...
                    using (var dialog = new Microsoft.WindowsAPICodePack.Dialogs.CommonOpenFileDialog { IsFolderPicker = true })
                    {
                        ...
                        {
                            pDocument.m_bImageInspectionMode = true;
                            if (false == CLoadingScreen.IsSplashScreen())
                            {
                                // 레시피를 로드 중입니다…
                                pDocument.GetMainFrame().ShowWaitMessage(true, "Load Simulation Image");
                            }
                            pDocument.m_objProcessMain.m_objCamera[(int)CDefine.enumCamera.CAMERA_1].HLSetImageFile(dialog.FileName);
                ...
                try {
                    if( System.Windows.Forms.DialogResult.OK == dialog1.ShowDialog() ) {
                        ...
                        pDocument.m_objProcessMain.m_objCamera[ ( int )CDefine.enumCamera.CAMERA_1 ].HLSetImageFile( dialog1.SelectedPath );
                        pDocument.GetMainFrame().ShowWaitMessage( false, "" );
