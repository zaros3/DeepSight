...
{
    public class CVisionLibraryCogBlob : HLDevice.Abstract.CVisionLibraryAbstract
    {
        ...
        public override bool HLLoadRecipe( string strRecipePath, string strRecipeName )
        {
            ...
            do {
                ...
                string strFileName = strRecipePath + "\\" + strRecipeName + "\\" + string.Format( "Blob{0}.VPP", m_iIndex );
