...
{
	public class CDeviceCameraVirtualGocator : CDeviceCameraAbstract
	{
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		// private
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		//설명 : 
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		public CDeviceCameraVirtualGocator()
		{
			m_bThreadExit = false;
			m_objCallback = null;
        ...
        public override bool HL3DSetSimulationImage( string strPath )
        {
            return InitializeImage( strPath );
        }
        ...
        private bool InitializeImage()
		{
			...
			do {
				...
				try {
                    ...
                    // 						pDocument.m_objConfig.GetSystemParameter().eMachineType.ToString() + "Gocator",
                    // 						DeepSight.CDefine.DEF_SIMULATION_IMAGE_PATH, m_iCameraIndex );

                    string strImagePath = string.Format( @"{0}\{1}\{2}\{3}{4:D}",
                                                pDocument.m_objConfig.GetSystemParameter().strSimulationImagePath,
                                                DeepSight.CDefine.DEF_SIMULATION_IMAGE_PATH,
                                                pDocument.m_objConfig.GetSystemParameter().eMachineType.ToString() + "Gocator",
                                                DeepSight.CDefine.DEF_SIMULATION_IMAGE_PATH, m_iCameraIndex );
                    ...
                    for( int iLoopCount = 0; iLoopCount < DeepSight.CDefine.DEF_MAX_COUNT_INSPECTION_POSITION; iLoopCount++ ) {
					...
					for( int iLoopCount = 0; iLoopCount < arFileNames.Length; iLoopCount++ ) {
                        ...
                        try {
                            ...
                            // 시뮬레이션 할때 동일포지션만 쭉 테스트하기 위함
                            if( 5 != strData.Length ) continue;
                            int iPosition = Int32.Parse( strData[ 1 ].Replace( "POSITION_", "" ) ) - 1;

                            byte[] objDataIntensity;
                            short[] objDataHeight;
                            if( -1 != arFileNames[ iLoopCount ].IndexOf( "Height" ) ) {
                                objDataHeight = new short[ objListReadData.Count ]; 
                                ...
                                //objListDataHeight.Add( objDataHeight );
                                //objListSizeWidth.Add( Int32.Parse( strData[ 1 ] ) );
                                //objListSizeHeight.Add( Int32.Parse( strData[ 2 ] ) );
                                objListDataHeight[ iPosition ] = objDataHeight;
                                objListSizeWidth[ iPosition ] = Int32.Parse( strData[ 2 ] );
                                objListSizeHeight[ iPosition ] = Int32.Parse( strData[ 3 ] );
                            } else if( -1 != arFileNames[ iLoopCount ].IndexOf( "Intesnisy" ) ) {
                                objDataIntensity = new byte[ objListReadData.Count ];
                                for( int iLoopData = 0; iLoopData < objListReadData.Count; iLoopData++ ) {
                                    objDataIntensity[ iLoopData ] = byte.Parse( objListReadData[ iLoopData ] );
                                }

                                //objListDataIntensity.Add( objDataIntensity );
                    ...
                    if( 0 >= objListDataIntensity.Count || 0 >= objListDataHeight.Count ) break;

                    for( int iLoopCount = 0; iLoopCount < objListDataHeight.Count; iLoopCount++ ) {
                        CImageData objImageData = new CImageData();
                        objImageData.objCameraData3D.iResolutionX = 200;
                        objImageData.objCameraData3D.iResolutionY = 200;
                        objImageData.objCameraData3D.iResolutionZ = 200;

                        objImageData.objCameraData3D.iWidth = objListSizeWidth[ iLoopCount ];
                        objImageData.objCameraData3D.iHeight = objListSizeHeight[ iLoopCount ];
                        objImageData.objCameraData3D.objHeightDataOrigin = objListDataHeight[ iLoopCount ];
                        objImageData.objCameraData3D.objIntensityDataOrigin = objListDataIntensity[ iLoopCount ];
                        objImageData.bitmapImage = new Bitmap( 1, 1 );
        ...
        //설명 : 
        //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        private bool InitializeImage( string strPath)
        {
            bool bReturn = false;
        ...
        //설명 : 
        //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        public override bool HL3DStart( int iIndex )
        {
            bool bReturn = false;
            do {
                if( null != m_objCallback ) {
                    if( iIndex >= m_lstImageData.Count ) break;
                    CImageData objImageData = m_lstImageData[ iIndex ].Clone() as CImageData;
		...
		{
            CDeviceCameraVirtualGocator pThis = ( CDeviceCameraVirtualGocator )state;
