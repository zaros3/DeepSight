...
namespace DeepSight {
    public class CProcessVisionProcess110 : CProcessAbstract {
        //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        //enum
        //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        // 유닛 명령
        ...
        //설명 : 
        //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        public CProcessVisionProcess110()
		{
		}
        ...
        private void M_objPMSManager_ProcessDoneEvent()
        {
            ...
            pDocument.SetUpdateDisplayOriginal( pDocument.GetInspectionIndex(), ( int )CFormMainProcess110.enumDisplayIndex.PMS );
            SetEvent( enumEvent.EVENT_PMS );
        }
        ...
        public void SetCallbackGrabImage( HLDevice.Abstract.CDeviceCameraAbstract.CImageData objImageData )
		{
            ...
            do {
                ...
                if( false == m_bGrabComplete ) {
                    string strErrorLog = string.Format( "CProcessVisionProcess110 {0} SetCallbackGrabImage Grab Complete false", m_iCameraIndex );
        ...
        public void SetOriginalImage( HLDevice.Abstract.CDeviceCameraAbstract.CImageData objImageData )
        {
            ...
            // 에러 로그
            string strErrorLog = string.Format("CProcessVisionProcess110 {0} SetPMSImage ", m_iCameraIndex );
            // 검사 제대로 동작했는지 유무
            ...
            pDocument.SetUpdateDisplayOriginal( pDocument.GetInspectionIndex(), ( int )CFormMainProcess110.enumDisplayIndex.ORIGIN_1 + objResult.objResultCommon.iIndexDisplayOriginalImage );
        }
            ...
            do {
                ...
                if( null != objPatternData.objCogImage ) {
                    for( int iLoopCount = 0; iLoopCount < objRecipeParameter.objInspectionParameter[ iInspectionIndex ].iCountSerchRegion; iLoopCount++ ) {
                        ...
                        // 센서 크기
                        objParameter.nSensorStdWid = objRecipeParameter.objInspectionParameter[ iInspectionIndex ].objMeasureParameter.iSensorStdWid;
                        objParameter.nSensorStdHgt = objRecipeParameter.objInspectionParameter[ iInspectionIndex ].objMeasureParameter.iSensorStdHgt;
                        //objParameter.nSensorStdWid = 192;
                        //objParameter.nSensorStdHgt = 117;
                        // 찾기
                        objParameter.nThresh = objRecipeParameter.objInspectionParameter[ iInspectionIndex ].objMeasureParameter.iSensorThresh;



                        m_objMeasureManager.SetInspectionSensor( objParameter );

                        CMeasureManager.structureMeasureResult objMeasureResult = m_objMeasureManager.GetResultSensor();
                        ...
                        if( 1 > objMeasureResult.iWidth || 1 > objMeasureResult.iHeight ) {
                            m_objMeasureManager.SetInspectionSensor( objParameter );
                            objMeasureResult = m_objMeasureManager.GetResultSensor();
                            m_objMeasureParameter[ iLoopCount ].objResultRegion.dStartX = objMeasureResult.iStartX;
                            m_objMeasureParameter[ iLoopCount ].objResultRegion.dStartY = objMeasureResult.iStartY;
                            m_objMeasureParameter[ iLoopCount ].objResultRegion.dEndX = objMeasureResult.iWidth;// objMeasureResult.iEndX;
                            m_objMeasureParameter[ iLoopCount ].objResultRegion.dEndY = objMeasureResult.iEndY - objMeasureResult.iStartY;//objMeasureResult.iHeight;// objMeasureResult.iEndY;
...
//                 }
		...
		{
            CProcessVisionProcess110 pThis = (CProcessVisionProcess110)state;
