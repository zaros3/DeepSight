...
namespace DeepSight
{
	public class CProcessVisionManagerProcess110 : CProcessAbstract
	{
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//private property
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		// 타입 ( Input Tray )
		private Type m_typeProcessVisionProcess110;
		...
		public CProcessAbstract[] m_objProcessVisionProcess110;
		// 매니저 변수
		...
		//설명 : 
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		public CProcessVisionManagerProcess110()
		{
		}
		...
		public override bool Initialize()
		{
			...
			do {
                ...
                // 비전 얼라인
                m_objProcessVisionProcess110 = new CProcessAbstract[ ( int )CDefine.enumCamera.CAMERA_FINAL ];
				for( int iLoopCount = ( int )CDefine.enumCamera.CAMERA_1; iLoopCount < ( int )CDefine.enumCamera.CAMERA_FINAL; iLoopCount++ ) {
                    CProcessVisionProcess110 obj = new CProcessVisionProcess110();
					obj.Initialize( iLoopCount );
                    m_objProcessVisionProcess110[ iLoopCount ] = obj;
                    m_typeProcessVisionProcess110 = obj.GetType();
				}
		...
		public override void DeInitialize()
		{
			...
			// 비전 얼라인
			for( int iLoopCount = ( int )CDefine.enumCamera.CAMERA_1; iLoopCount < ( int )CDefine.enumCamera.CAMERA_FINAL; iLoopCount++ ) {
				if( null != m_objProcessVisionProcess110[ iLoopCount ] ) {
                    CProcessVisionProcess110 obj = m_objProcessVisionProcess110[ iLoopCount ] as CProcessVisionProcess110;
					if( null != obj ) {
						obj.DeInitialize();
					}
				}
        ...
        public bool DoProcessInspection( int iCameraIndex )
		{
            ...
            do {
               ...
               // string strCellID = "";
                ...
                // PMS 이미지 만들기
                CProcessVisionProcess110 obj = m_objProcessVisionProcess110[ iCameraIndex ] as CProcessVisionProcess110;
                obj.SetCommand( CProcessVisionProcess110.enumCommand.CMD_START_PMS );

                int iTimeOut = 25000;
                int iTimePeriod = 3;
                while( CProcessVisionProcess110.enumCommand.CMD_IDLE != obj.GetCommand() && iTimeOut > 0 ) {
                ...
                if( CProcessVisionProcess110.enumStatus.STS_ERROR == obj.GetStatus() ) {
                ...
                objStopwatch.Restart();
                // PMS 이미지 만들기
                obj.SetCommand( CProcessVisionProcess110.enumCommand.CMD_START_PMS_MEASURE );
                ...
                objStopwatch.Restart();
                obj.SetCommand( CProcessVisionProcess110.enumCommand.CMD_START_INSPECTION );
                iTimeOut = 25000;
                iTimePeriod = 3;
                while( CProcessVisionProcess110.enumCommand.CMD_IDLE != obj.GetCommand() && iTimeOut > 0 ) {
                    iTimeOut -= iTimePeriod;
            ...
            pDocument.SetUpdateDisplayPMS( pDocument.GetInspectionIndex(), ( int )CFormMainProcess110.enumDisplayIndex.PMS );
            ...
            for( int iLoopCount = 0; iLoopCount < ( CDefine.DEF_MAX_COUNT_CROP_REGION - 3 ); iLoopCount++ ) {
                pDocument.SetUpdateDisplayResultVIDI( pDocument.GetInspectionIndex(), ( int )CFormMainProcess110.enumDisplayIndex.VIDI_1 + iLoopCount );
            }

            // 여기서 결과 디스플레이를 뿌리자
            for( int iLoopCount = 0; iLoopCount < ( CDefine.DEF_MAX_COUNT_CROP_REGION - 3 ); iLoopCount++ ) {
                pDocument.SetUpdateDisplayResultMeasure( pDocument.GetInspectionIndex(), ( int )CFormMainProcess110.enumDisplayIndex.MEASURE_1 + iLoopCount );
            }
        ...
        public bool DoProcessTrigger( int iCameraIndex )
        {
            ...
            do {
                CProcessVisionProcess110 obj = m_objProcessVisionProcess110[ iCameraIndex ] as CProcessVisionProcess110;
                // 라이브 모드 OFF
                obj.SetCommand( CProcessVisionProcess110.enumCommand.CMD_LIVE_END );
                ...
                if( CDefine.enumRunMode.RUN_MODE_STOP == pDocument.GetRunMode() ) {
                    // 트리거 ON
                    obj.SetCommand( CProcessVisionProcess110.enumCommand.CMD_START_GRAB );
        ...
        public bool DoProcessTriggerMeasure( int iCameraIndex )
        {
            ...
            do {
                ...
                if( CDefine.enumRunMode.RUN_MODE_STOP == pDocument.GetRunMode() ) {
                    // 트리거 ON
                    obj.SetCommand( CProcessVisionProcess110.enumCommand.CMD_START_GRAB_MEASURE );
			...
			do {
				...
				if( true == bLiveMode ) {
					if( CDefine.enumLiveMode.LIVE_MODE_ON == pDocument.GetLiveMode( iCameraIndex ) ) {
						obj.SetCommand(CProcessVisionProcess110.enumCommand.CMD_LIVE_START );
					}
				}
				// 라이브 OFF
				else {
		...
		private static void ThreadManager( object state )
		{
            ...
            CProcessVisionManagerProcess110 pThis = (CProcessVisionManagerProcess110)obj.pThis;
			...
			while( false == pThis.m_bThreadExit ) {
                ...
                // 트레이 파트
				if( pThis.m_typeProcessVisionProcess110 == pThis.m_objProcessVisionProcess110[ iCameraIndex ].GetType() ) {
