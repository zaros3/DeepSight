...
namespace DeepSight
{
	public partial class CFormMain : Form, CFormInterface
	{
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		// private
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		public bool InitializeForm()
		{
			...
			do {
				...
				int iMenuCount = ( int )CDefine.FormViewMain.FORM_VIEW_MAIN_FINAL;
				// 버튼 여백 & 넓이 설정
				int iWhiteSpace = 2;
				...
				for( int iLoopButton = 0; iLoopButton < strButtonName.Length; iLoopButton++ ) {
					strButtonName[ iLoopButton ] = ( ( CDefine.FormViewMain )iLoopButton ).ToString();
				}
				// 버튼 동적 생성
				...
				// 화면 전환
				SetChangeForm( CDefine.FormViewMain.FORM_VIEW_MAIN_ALIGN );
		...
		public bool SetChangeLanguage()
		{
			...
			do {
				...
				SetControlChangeLanguage( m_btnMenu[ ( int )CDefine.FormViewMain.FORM_VIEW_MAIN_ALIGN ] );
		...
		public void ButtonMenu_Click( object sender, EventArgs e )
		{
			...
			try {
				...
				if( true == objRegex.IsMatch( objButton.Name ) ) {
					...
					CDefine.FormViewMain eFormView = ( CDefine.FormViewMain )Convert.ToInt32( strText );
					// 버튼 로그 추가
		...
		//설명 : 
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		public Form GetFormMain( CDefine.FormViewMain eViewMain )
		{
			Form objForm = null;

			do {
				if( null == m_stForm[ ( int )eViewMain ].m_objForm ) break;
				objForm = m_stForm[ ( int )eViewMain ].m_objForm;
			} while( false );
		...
		{
			var pFormCommon = CFormCommon.GetFormCommon;
			for( int iLoopMenu = 0; iLoopMenu < ( int )CDefine.FormViewMain.FORM_VIEW_MAIN_FINAL; iLoopMenu++ ) {
